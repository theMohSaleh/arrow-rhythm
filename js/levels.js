...
const levelCombos = [
    // Easy Level - 110 difference in coordinates
    [
    ...
    // Normal Level - 175 difference in coordinates
    [
    ...
    [
        ...
        { arrow: "↓", startPos: { x: 320, y: 290 }, hitPos: { x: 100, y: 70 }, velocity: 1 },
        { arrow: "←", startPos: { x: 360, y: 290 }, hitPos: { x: 140, y: 70 }, velocity: 1 },
        { arrow: "↑", startPos: { x: 400, y: 290 }, hitPos: { x: 180, y: 70 }, velocity: -1 },
        { arrow: "→", startPos: { x: 440, y: 290 }, hitPos: { x: 210, y: 70 }, velocity: 1 },
